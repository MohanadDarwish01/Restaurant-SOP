...
export default function SideMenu() {
    const [links] = useState([
        ...
        { id:2, name: "Food & Drinks", icon: <IoFastFood />, path: "/order" },
    ...
    return (
        <div className=" d-flex flex-column" id={style.SideMenu}>
            ...
            <div className=' col-12 d-flex flex-column gap-2 align-items-center p-3'>
                {
                    links.map((el, index) => {
                        return (
                            <Link key={index} to={el.path} className={" w-100 nav-link rounded d-flex align-items-center gap-2 py-2 px-4 " + style.activeLink}>
                                {el.icon}
